        ...
        <>
            <div className="banner">
                <div className="banner__backgrounds">
                    <div className="banner__backgrounds--image landscape"></div>
                    <div className="banner__backgrounds--image rocks"></div>
                    <div className="banner__backgrounds--image cartoon"></div>
                </div>
